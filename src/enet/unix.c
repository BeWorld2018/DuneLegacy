...
{
    addr->s_addr = inet_addr((const unsigned char*)cp);
...
#endif
#else
    hostEntry = gethostbyname ((const unsigned char*)name);
#endif
...
enet_address_get_host (const ENetAddress * address, char * name, size_t nameLength)
{
    ...
    hostEntry = gethostbyaddr ((unsigned char *) & in, sizeof (struct in_addr), AF_INET);
#endif
